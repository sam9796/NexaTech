...
function events() {
    ...
    const getData=async ()=>{
        const resp=await fetch('http://13.232.129.172:8000/getEvents',{
            method:'GET',
            headers:{
                'Content-Type':'application/json',
    ...
    closeOnClick:true
       ...
       const resp=await fetch('http://13.232.129.172:8000/saveEvent',{
        method:'POST',
        headers:{
            'Content-Type':'application/json',
            'auth-token':localStorage.getItem('token')
    ...
    const handleDelete=async (id)=>{
        const resp=await fetch('http://13.232.129.172:8000/deleteEvent',{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json',
                'auth-token':localStorage.getItem('token')
    ...
    const handleEditEvent=async ()=>{
        ...
        closeOnClick:true
           ...
           const resp=await fetch('http://13.232.129.172:8000/editEvent',{
            method:'PATCH',
            headers:{
                'Content-Type':'application/json',
                'auth-token':localStorage.getItem('token')
