...
function Sidebar() {
  ...
  return (
    <div className='flex flex-col gap-3 mt-5'>
        ...
        <div className={`${nav[0]?'bg-[#315EFF]':''} w-1 h-full`}></div>
      ...
      <div className='flex gap-9'>
        <div className={`${nav[1]?'bg-[#315EFF]':''} w-1 h-full`}></div>
